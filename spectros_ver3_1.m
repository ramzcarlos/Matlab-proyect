...
size_T=size(T);
size_T=size_T(1);
% Modificacion con inicio de 0.1, 0.2,...,4.0
%T=zeros(1,size_T);
cont_incre=0;
...
if n_file > 1
	...
	while resp == 'Y'  | resp == 'y'
    	...
    	if grafica =="D"
         	...
         	hold on
         	for i=1:n_file
             	plot(T,M(1:s_t,g_d), dis_grafica(i),'Linewidth',2 )
    	...
    	elseif grafica =="V"
        	...
        	hold on
        	for i=1:n_file
            	plot(T,M(1:s_t,g_v), dis_grafica(i), 'Linewidth',2)
        	...
        	hold on
        	for i=1:n_file
            	plot(T,M(1:s_t,g_a), dis_grafica(i),'Linewidth',2 )
